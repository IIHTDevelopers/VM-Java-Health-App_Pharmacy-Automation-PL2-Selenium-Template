...
public class pharmacy_testcase extends AppTestBase {
	...
	// --------------------------------------------------------------------------
	// Pharmacy L1 test cases starts from here. (01-15)
	// --------------------------------------------------------------------------
	...
	public void verifyPharmacyModule() throws Exception {
		...
		Map<String, String> expectedData = new FileOperations().readJson(expectedDataFilePath, "Pharmacy");
	...
	public void verifyErrorMessageOnPrintingGoodReceiptWithoutDetails() throws Exception {
		...
		pharmacy_pl1_pageInstance.closeAddGoodReceiptModal();
	}
	...
	public void addNewGoodReceipt() throws Exception {
		...
		Map<String, String> newGriItemData = new FileOperations().readJson(expectedDataFilePath, "Pharmacy");
		...
		pharmacy_pl1_pageInstance.verifyMessageByText("Goods Receipt is Generated and Saved.");
	}
	...
	public void verifyAddedGoodReceipt() throws Exception {
		...
		pharmacy_pl1_pageInstance.doesPrintContainsInvoiceNumber(randomInvoiceNumber);
		pharmacy_pl1_pageInstance.closeAddGoodReceiptModal();
	}
	...
	public void verifyToolTipText() throws Exception {
		...
		Map<String, String> pharmacyExpectedData = new FileOperations().readJson(expectedDataFilePath, "Pharmacy");
	...
	public void verifyRecordsAccordingToSelectedSupplier() throws Exception {
		...
		Map<String, String> pharmacyExpectedData = new FileOperations().readJson(expectedDataFilePath, "Pharmacy");
		userActionsInstance
				.sendKeys(pharmacy_pl1_pageInstance.supplierNameDropdownXpath, pharmacyExpectedData.get("supplierName"))
				.sendKeys(pharmacy_pl1_pageInstance.supplierNameDropdownXpath, Keys.ENTER);
		userActionsInstance.click(pharmacy_pl1_pageInstance.showDetails);
		Assert.assertTrue(pharmacy_pl1_pageInstance.verifyGoodsReceiptTableDataIsPresentAfterEnteringSupplierName(),
				"Table data is not present for the selected supplier");
	}
	...
	@Test(priority = 15, groups = {
			"sanity" }, description = "Verify to filter the records by select complete radio button of list status\r\n"
					+ "Click on the \"Complete\" Radio button\r\n" + "Click on the \"Cancelled\" Radio button\r\n"
	...
	// --------------------------------------------------------------------------
	// Pharmacy L2 test cases starts from here. (16-21)
	// --------------------------------------------------------------------------
	...
	public void verifyPurchaseOrderDataAfterApplyingDateFilter() throws Exception {
		...
		String toDate = currentDate.format(formatter);
		String fromDate = date7DaysAgo.format(formatter);
		pharmacy_pl1_pageInstance.applyDateFilter("17-01-2024", toDate);
		Assert.assertTrue(
	...
	public void exportGoodsReceiptData() throws Exception {
		...
		pharmacy_pl1_pageInstance.visitTabUnderPharmacy("Order");
		pharmacy_pl1_pageInstance.clickButtonByText("Export");
	...
	public void verifyRegisterPatientWithPhoto() throws Exception {
		...
		userActionsInstance.click(pharmacy_pl1_pageInstance.patientTabXpath);
		userActionsInstance.click(pharmacy_pl1_pageInstance.registerPatient);
		userActionsInstance.click(pharmacy_pl1_pageInstance.profilePicture);
		userActionsInstance.click(pharmacy_pl1_pageInstance.newPhoto);
		userActionsInstance.click(pharmacy_pl1_pageInstance.chooseFileButton);
		Thread.sleep(5000);  // wait for file to get uploaded
		userActionsInstance.fileUpload(System.getProperty("user.dir") + "\\testImage\\uploadImage.png");
		Thread.sleep(5000);  // wait for file to get uploaded
		userActionsInstance.click(pharmacy_pl1_pageInstance.doneButton);
	}
